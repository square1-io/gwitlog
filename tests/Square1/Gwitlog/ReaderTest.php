...
class ReaderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testSetRemoteHostGithub()
    {
        ...
        $this->assertTrue($gwitlog->setRemoteHost('https://github.com/square1-io/gwitlog'));
    }
    ...
    public function testSetRemoteHostGithubNonHttps()
    {
        ...
        $gwitlog->hydrate($this->goodCommitWithBranch);
        // Valid link, should be true on assignment
        $this->assertTrue($gwitlog->setRemoteHost('http://github.com/square1-io/gwitlog'));
    }
    ...
    {
        $this->setExpectedException('\Square1\Gwitlog\Exception\InvalidRepositoryInformation');
        $gwitlog = new Reader();
        $gwitlog->hydrate($this->goodCommitWithBranch);
        // Valid link, should be true on assignment
    ...
    public function testSetRemoteHostBitbucket()
    {
        ...
        $gwitlog->hydrate($this->goodCommitWithBranch);
        // Valid link, should be true on assignment
        $this->assertTrue($gwitlog->setRemoteHost('https://bitbucket.org/square1-io/gwitlog'));
    }
    ...
    public function testSetRemoteHostTrailingSlash()
    {
        ...
        $gwitlog->setRemoteHost('https://bitbucket.org/square1-io/gwitlog/');
    ...
    public function testSetRemoteHostBitbucketNonHttps()
    {
        ...
        $gwitlog->hydrate($this->goodCommitWithBranch);
        // Valid link, should be true on assignment
        $this->assertTrue($gwitlog->setRemoteHost('http://bitbucket.org/square1-io/gwitlog'));
    }
    ...
    {
        $this->setExpectedException('\Square1\Gwitlog\Exception\InvalidHost');

        $gwitlog = new Reader();
        $gwitlog->hydrate($this->goodCommitWithBranch);

        $this->assertTrue($gwitlog->setRemoteHost('https://foobaretc.com/square1-io/gwitlog'));
    }
    ...
    public function testGetRemoteLinkForGithub()
    {
        ...
        $this->assertEquals(
            'https://github.com/square1-io/gwitlog/commit/' . $this->log['hash'],
    ...
    public function testGetRemoteLinkForBitbucket()
    {
        ...
        $this->assertEquals(
            'https://bitbucket.org/square1-io/gwitlog/commits/' . $this->log['hash'],
            $gwitlog->getRemoteLink()
        );
    }
